...
namespace Proyecto_Integrador.Utils
{
    public class GeneradorFacturaPDF
    {
        ...
        public GeneradorFacturaPDF(Models.Factura factura, DataGridView grid)
        {
        ...
        public void Exportar(string rutaPdf)
        {
            ...
            decimal subtotal = (decimal)factura.subtotal;
            decimal iva = (decimal)factura.precioIva;
            decimal total = (decimal)factura.total;
                        ...
                        col.Item().Row(row =>
                        {
                            ...
                            row.ConstantItem(200).Column(c =>
                            {
                                c.Item().Row(r =>
                                {
                                    ...
                                    r.ConstantItem(80).AlignRight().Text(subtotal.ToString("C2"));
                                });
                                c.Item().Height(4);
                                c.Item().Row(r =>
                                {
                                    r.RelativeItem().Text("Iva (19%):");
                                    r.ConstantItem(80).AlignRight().Text(iva.ToString("C2"));
                                });
                                c.Item().Height(6);
                                c.Item().Row(r =>
                                {
                                    ...
                                    r.ConstantItem(80).AlignRight()
                                        .Text(total.ToString("C2")).Bold().FontSize(11);
                                });
                            });
                        });
                    });
